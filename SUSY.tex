...
\eq{EL}
{
 \partial_{\mu}\left (\pdv{\mathcal{L}}{(\partial_{\mu}\phi_{i})}\right) = \pdv{\mathcal{L}}{\phi_{i}},~i=1,2,3,4
}
...
\eq{kglagrangian}
{
 \mathcal{L}_{Klein-Gordon} = \frac{1}{2}(\partial_{\mu} \phi)(\partial^{\mu} \phi) - \frac{1}{2} \left(\frac{mc}{\hbar} \right)^{2} \phi^{2},
}
