...
%	- mainly the out-of-time will not be corectly described, firstly of incorrect pulse shape, but also because of the dependence of the cross talk on the particle arrival time. This could be considered for implementation in the smulation.
...
%pulse shape problematics -> the out-of-time is not well described
...
%-soon update of the analysis
%- in our analysis what can we improve?
%-background estimations 
%	-reduce systematics-> larger potential
%	-met extrapolation, extrapolations in general
%	-data driven techniques as much as possible
%	-improve uncertainties on objects and theoretical parameters

%-signal
%	-use fullsim at least in the problematic areas

%-new bdt techiques instead of cut and count
%	-but pay attention not to be too dependent on modelling of some variable

%-tagging of objects
%-optimization of signal regions
%-use best posible identification (discriminations) of objects
%-best possible simulated samples - NLO welll I do not know...
%-make sure that there is enough statistics in each bin to evoid large stat uncertainties
