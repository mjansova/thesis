...
At the PSI beam test, the measurement of the HIP probability was also provided. The HIP probabilityi labelled as~$P_{HIP}(CMN_{HIP}\leq CMN_{threshold})$ is defined as 
