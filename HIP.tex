...
%TODO the dynamic inefficiencies are gone -. have a look if we still see HIP and what is the probability and its manifestation
...
The fake clusters in events after HIP interaction can be dangerous for tracking as they can be used for track reconstruction instead of the real clusters. But this effect scales with probability of HIP vent, which is relatively small.
...
\hline
Events/Quantities & Average cluster charge~[ADC] & Average cluster multiplicity & Average cluster width~[strip] & Fraction of clusters larger than 10 strips \\
\hline
